# Django settings for jocatus project.
import os
...
#        'NAME': 'jocatus_bdd',                      # Or path to database file if using sqlite3.
...
DATABASES = {
    'default': {
        ...
        'NAME': 'jocatus.db',                      # Or path to database file if using sqlite3.
        'USER': 'root',                      # Not used with sqlite3.
        'PASSWORD': 'root',                  # Not used with sqlite3.
        'HOST': '',                      # Set to empty string for localhost. Not used with sqlite3.
        'PORT': '',                      # Set to empty string for default. Not used with sqlite3.
...
STATICFILES_DIRS = (
    ...
    '/home/pilou/Documents/PYT/jocatus/jocatus/static',
)
...
SECRET_KEY = 'lw7-om9+qg+ll^yqpc+zxbi$#l-_y$c25c*lq*bryqo&amp;q0mqlz'
...
ROOT_URLCONF = 'jocatus.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'jocatus.wsgi.application'
